...
public class OpExam {
	...
	public static void main(String[] args) {
		...
		x += 3;
		x++; // 위와 같은 코드
				// 단, 1을 증가할때만 다 같은 거지만 더 편리한게 x++이거다 단 증가1할때만
		...
		// 소수점을 비교 할 때는 같은 타입으로 변환해서 비교하자
		...
		int s = 95;
		String grade = (s > 90) ? "A" : "B"; //전체가 참이면 A로 바꿔도된다
